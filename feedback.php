...
<html lang="en">
  ...
  <body onload="createCaptcha()">
    ...
    <section class="map-form">
        <div class="container d-flex py-5 flex-wrap align-items-center">
          <div class="map col-12 col-lg-5">
            <img src="<?=$_baseurl?>assets/images/banner-right-img2.webp" class="w-100" alt="">
          </div>
          <div class="form col-12 col-lg-7 contact-form ps-lg-5">

                        <h2 class='section-title text-white'>Give Your Valuable Feedback</h2>
        ...
        <script>
            ...
            function validateCaptcha() {
                ...
                if (fullname.length != "" && phone.length != "" && email.length != "" && comment.length != ""){
                    ...
                    From : "feedback@streamlinedchauffeurs.com",
                    ...
                    Body : body
                        ...
                        window.location = 'http://localhost/streamlined/thank-you/';
                        }
                    );
                }else{
                    formValidate = false;
